%-------------------------------------------------------------------------------------------%
% Program to simulate the 2X2 HOL switch using markovs chain property
% Calculate the number of packets at the input buffer1 and input buffer 2
% Plot the graph of number of packets in input buffer as a function of arrival probabilitis
%-------------------------------------------------------------------------------------------%
...
% Running the loop for number of time slots and observing the buffer of the HOL switch
for Iteration_Var1=1:1:Number_Of_Time_Slots
      Packets_Processed=0;
      %Count_Of_1Packets=0;
      %Count_Of_2Packets=0;
      %Arrival_Random_Number=rand();
     ...
     Random_Number=rand();
     % Enter only If the input buffers are not empty 
       if(Input_Buffer_1>0 && Input_Buffer_2>0)
           % Checking different cases of the arrived packets.
