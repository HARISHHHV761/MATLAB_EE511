...
for Iteration_Var1=1:1:Number_Of_Time_Slots
     ...
     if(Arrival_Random_Number >Arrival_Probabilities(Iteration_Var1))% Packets arriving at Input buffer 1
     Input_Buffer_1=Input_Buffer_1+1;
     end
     if(Arrival_Random_Number>Arrival_Probabilities(Iteration_Var1))% Packets arriving at Input buffer 2
