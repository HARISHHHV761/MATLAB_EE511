...
function r = Project6_Q3(alpha,beta,gamma,delta,varargin)
...
y=hist(r,xlength);
bar(xlength,y);
title('The histogram of the number of samples');
xlabel('The range of X ');
ylabel('The frequency of the samples falling in the X range');

figure(2)
plot( xlength , stblpdf(xlength,alpha,beta,gamma,delta,'quick'));
title('The theoretical pdf of the alpha stable random variable');
xlabel('The range of X ');
ylabel('The probability(pdf) of the different values of x');

figure(3)
title('The graph shows the theoritical pmf overlayed on the histogram of random variable generated by M ');
yyaxis left
y=hist(r,xlength);
bar(xlength,y);
ylabel('The frequency of the number of samples generated');
yyaxis right
plot(xlength,stblpdf(xlength,alpha,beta,gamma,delta,'quick'),'r');
ylabel('The PDF of the Alpha Stable Distribution');

figure(4)
plot(1:1000,r);
title('The time series of the generated samples');
xlabel('The range of generated samples');
ylabel('The generated samples using Mallow Stuck method');
end
...
%====  function to find theoretical pdf ======%
