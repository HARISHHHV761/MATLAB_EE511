...
%A Function Project1 is created for modularizing and reusability
...
function[Head_Count]=Project1(Mutiple) % A function with output Head_Count and input Multiple
Temporary_Head=0;
...
Head_Count=50-Tails_Count;  %Count for number of Heads.
disp('The number of heads=')
disp(Head_Count) 
disp('The vector of random variables=')
disp(Vector_A)
histogram(Vector_D,2) % Creating a histogram to generate Bernoulli outcome for Vector_A
title('Histogram showing the Bernoulli outcome of heads and tails for 50 tossings')
xlabel('Bernoullis Outcome : Head and Tails')
ylabel('Number of occurence of head and tails ')
disp('The maximum headrun length count =')
disp(Maximum_HeadRunLength) 
end
